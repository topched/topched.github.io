...
module.exports = {
	...
	"services": [
		...
		},
		{
			...
			"benefit": true,
			"items": [
				"Easy to clean, seamless surface: Our epoxy floor coating becomes a durable, seamless surface that can be easily cleaned. Epoxy floor coatings are great for both residential and commercial floors.",
				"Chemical Resistant: Epoxy floor coatings are chemically resistant making it an ideal flooring option for any commercial or industrial needs.",
				"Work of Art: Our epoxy floor coatings dry to a high gloss shine and are available in a variety of different colors and styles.",
				"Cost Savings: If you are rejuvenating an old slab or finishing new concrete, epoxy provides a protective decorative surface with very little maintenance."
			]
		},
		{
...
var serviceData = __webpack_require__(27);
